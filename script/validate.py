...
class Activity():
    ...
    def testcase_check_BigTable_Instance_name(self,test_object,credentials,project_id):
        ...
        try:
            ...
            if is_present==True:
                ...
                test_object.update_result(0,expected_result,actual,"Check BigTable instance name","https://cloud.google.com/bigtable/docs/")   
    ...
    def testcase_check_Table_name(self,test_object,credentials,project_id):
        ...
        try:
            ...
            if is_present==True:
                ...
                test_object.update_result(0,expected_result,actual,"Check Bigtable Table name","https://cloud.google.com/bigtable/docs/")   
    ...
    def testcase_check_column_family1(self,test_object,credentials,project_id):
        ...
        try:
            ...
            if is_present==True:
                ...
                test_object.update_result(0,expected_result,actual,"Check Column Family name","https://cloud.google.com/bigtable/docs/")   
    ...
    def testcase_check_column_family2(self,test_object,credentials,project_id):
        testcase_description="Check Sales Column Family name"
        bigtable_id = "Company Sales"
        bigtable_table_id = "UserSessions"
